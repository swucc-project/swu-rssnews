...
const isActive = (routeName) => {
    return route.name === routeName || route.path.startsWith(`/rss/${routeName}`);
};
</script>
        ...
        <div class="container mx-auto px-4">
            <div class="navbar p-0">
                ...
                <div class="navbar-start">
                    <RouterLink 
                        :to="{ name: 'Home' }"
                        class="btn btn-ghost normal-case text-xl font-sarabun-new text-white hover:bg-white/10"
                    >
                ...
                <div class="navbar-center hidden lg:flex">
                    <ul class="menu menu-horizontal p-0 gap-1">
                        ...
                        <li>
                            <RouterLink 
                                :to="{ name: 'Home' }"
                                class="font-sarabun-new text-white hover:bg-white/10 rounded-md px-4 py-2"
                                :class="{ 'active bg-white/20 font-bold': route.name === 'Home' }"
                            >
                        ...
                        <template v-if="authStore.isAuthenticated">
                            ...
                            <li>
                                <RouterLink 
                                    :to="{ name: 'AddRSSItem' }"
                                    class="font-sarabun-new text-white hover:bg-white/10 rounded-md px-4 py-2"
                                    :class="{ 'active bg-white/20 font-bold': route.name === 'AddRSSItem' }"
                                >
                                    <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li>
                                <RouterLink 
                                    :to="{ name: 'UpdateRSSItem', params: { itemID: 'select' } }"
                                    class="font-sarabun-new text-white hover:bg-white/10 rounded-md px-4 py-2"
                                    :class="{ 'active bg-white/20 font-bold': route.name === 'UpdateRSSItem' }"
                                >
                                    <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <li>
                                <RouterLink 
                                    :to="{ name: 'DeleteRSSItem', params: { id: 'select' } }"
                                    class="font-sarabun-new text-white hover:bg-white/10 rounded-md px-4 py-2"
                                    :class="{ 'active bg-white/20 font-bold': route.name === 'DeleteRSSItem' }"
                                >
                                    <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <RouterLink 
                                :to="{ name: 'ViewFeed' }"
                                class="font-sarabun-new text-white hover:bg-white/10 rounded-md px-4 py-2"
                                :class="{ 'active bg-white/20 font-bold': route.name === 'ViewFeed' }"
                            >
                ...
                <div class="navbar-end gap-2">
                    <RouterLink 
                        ...
                        :to="{ name: 'SignIn' }"
                        class="btn btn-ghost font-sarabun-new text-white hover:bg-white/10"
                    >
                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
